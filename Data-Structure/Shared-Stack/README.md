...
```mermaid
flowchart
    classDef dotA fill:#fff,stroke:#05f ,stroke-width:1.2px,width:100px,height:100px,font-family:Times New Roman ,font-size:12px , font-weight: bold;
    classDef dotB fill:#fff ,stroke:#a0f ,stroke-width:1.2px , font-family:Times New Roman ,font-size:12px , font-weight: bold;
