...
int main() {
  ...
  std::cout << "topo_sort sequence:";
  auto res = dirListGraph.topo_sort();
  ...
  std::cout << std::format("the {} length path exist:{}\n", 4,
                           undirListGraph.path_exist(4));
  std::cout << std::format("the {} length path exist:{}\n", 8,
                           undirListGraph.path_exist(8));
  std::cout << "=========================================\n";
  std::cout << "dir Matrix Graph\n";
  std::cout << std::format("the {} length path exist between {} and {} is {}\n",
                           2, 1, 4, dirMatrixGraph.exit_path_length(1, 4, 2));
  std::cout << std::format("the {} length path exist between {} and {} is {}\n",
                           2, 0, 2, dirMatrixGraph.exit_path_length(0, 2, 2));
  ...
  std::for_each(afterTopo.begin(), afterTopo.end(),
                [](int i) { std::cout << i << " "; });
  std::cout << "\n======================================\n";
