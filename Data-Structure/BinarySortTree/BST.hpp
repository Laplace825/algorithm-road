 ...
 * @LastEditTime: 2024-04-23 15:28:29
...
#include <queue>
namespace BT {
template <typename Elem> class BST : public LinkBinaryTree<Elem> {
...
template <typename Elem> bool BST<Elem>::insert(const Elem &v) noexcept {
